...
if(app){
  ...
  style.textContent=`
    html body .phase-note::after{content:'Windows 1.2.17 本地前端 · 头像资料卡与会员中心'!important}
    ...
    body.square-scroll-locked [data-view-panel="square"]{height:100vh;min-height:0;overflow:hidden}
    ...
    body.square-scroll-locked .detail-content-scroll{min-height:0;overflow-y:auto;overscroll-behavior:contain;scrollbar-gutter:stable}
    body.square-scroll-locked .comment-list{overflow:visible}
    ...
    body.buddy-scroll-locked [data-view-panel="buddy"]{height:100vh;min-height:0;overflow:hidden}
