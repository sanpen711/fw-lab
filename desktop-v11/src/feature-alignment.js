...
function injectExtraViews(){
  ...
  const rules=document.createElement('button');rules.className='nav-item';rules.type='button';rules.dataset.alignNav='rules';rules.innerHTML='<span class="nav-icon nav-icon-info" aria-hidden="true"></span><b>入馆须知</b>';
  const moderation=document.createElement('button');moderation.className='nav-item';moderation.type='button';moderation.dataset.alignNav='moderation';moderation.innerHTML='<span class="nav-icon nav-icon-notice" aria-hidden="true"></span><b>处理公告</b>';
