const CACHE_NAME = 'fw-mobile-app-auth-clean-final-20260608-1';
...
function injectAppTweaks(html){
  ...
  next = next.replace(/\.\/profile-login-ui\.js\?v=[^"']+/g, './profile-login-ui.js?v=mobile-auth-clean-final-20260608-1');
