...
assert.match(workflow, /fw-lab-windows-1\.2\.18/);
assert.match(workflow, /version = '1\.2\.18'/);
...
assert.match(workflow, /storage\/v1\/object\/public\/app-releases\/fw-lab-windows-1\.2\.18-setup\.exe/, '正式更新地址应使用 Supabase Storage 的版本化安装包');
