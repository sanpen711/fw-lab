...
assert.match(app, /if\(!isSquareSurface\) loadJs\("assets\/fw-stable-core\.js/, '精神广场和独立发布页不应恢复首屏预载稳定核心');
...
assert.match(square, /assets\/app\.js\?v=square-echo-sync-20260914-1/, '精神广场应刷新 app.js 的广场与回声同步缓存版本');
