(function(){
  ...
  function contentBody(text){
    ...
    plain = plain.replace(/\[伏伏1:(0[1-9]|1[0-9]|2[0-4])\]/g, function(_, number){
      media += '<img class="fw-square-img fw-square-fufu" src="assets/emoji/fufu1/' + number + '.webp" alt="伏伏表情" loading="lazy" decoding="async">';
      return '';
    });
